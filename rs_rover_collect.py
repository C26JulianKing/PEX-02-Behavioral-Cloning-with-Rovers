...
DEFAULT_DATA_PATH = 'rawdata/m_cc_m_d'  # Default directory for storing rover data
...
DEFAULT_PORT = "/dev/ttyACM0"  # Default telemetry connection port (UDP)
...
def collect_data(bag_file):
    ...
    try:
        ...
        config = rs.config()
        #Source: https://github.com/realsenseai/librealsense/issues/3044
    ...
    while connection and connection.armed:
        try:
            ...
            throttle = int(connection.channels.get('3', 1500))  # Default neutral throttle
